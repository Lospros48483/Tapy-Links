...
def app_2():
    system('start https://www.youtube.com') #opens Youtube

def app_3():
    system('start https://teams.microsoft.com') # opens Teams

def app_4():
    system('start https://scratch.mit.edu') # opens scratch

def app_5():
    system('start https://www.photopea.com') # open photopea

def app_6():
    system('start https://www.google.com') # open google

def app_7():
    system('start https://chatgpt.com') #opens Chat gpt

def app_8():
    system('start https://duckduckgo.com') # opens DuckDuckGo
